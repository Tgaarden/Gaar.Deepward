...
frame:Hide()
-- NOT added to UISpecialFrames on purpose: ESC must not close the threat meter (it shouldn't close with the
-- Deepward panel). Toggle it via /dwthreat or the panel button.
